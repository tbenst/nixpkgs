...
in rec {
  ...
  cudnn_cudatoolkit_redist_7 = cudnn_cudatoolkit_7.override({
  ...
  cudnn_cudatoolkit_redist_7_5 = cudnn_cudatoolkit_7_5.override({
    redistributable = true;
  });
  ...
  cudnn6_cudatoolki_redistt_8 = cudnn6_cudatoolkit_8.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_8 = cudnn_cudatoolkit_8.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_9_0 = cudnn_cudatoolkit_9_0.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_9_1 = cudnn_cudatoolkit_9_1.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_9_2 = cudnn_cudatoolkit_9_2.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_10_0 = cudnn_cudatoolkit_10_0.override({
    redistributable = true;
  });
  ...
  cudnn_cudatoolkit_redist_10_1 = cudnn_cudatoolkit_10_1.override({
    redistributable = true;
  });

  cudnn_cudatoolkit_10 = cudnn_cudatoolkit_10_1;
  
  cudnn_cudatoolkit_redist_10 = cudnn_cudatoolkit_10.override({
    redistributable = true;
  });
}
